    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-xl font-bold text-foreground sm:hidden">{user.email.split('@')[0]}</h1>
              
              {/* Desktop welcome message */}
              <h1 className="hidden sm:block text-2xl font-bold text-foreground">Welcome back, {user.email.split('@')[0]}!</h1>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 gap-4">
          <Link href="/booking" className="bg-card p-4 sm:p-6 rounded-lg shadow hover:shadow-md transition-shadow border border-border">
            <div className="flex items-center sm:items-start flex-col sm:flex-row">
              ...
              <div className="mt-2 sm:mt-0 sm:ml-4 text-center sm:text-left">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground sm:block hidden">Reserve a meeting room</p>
              </div>
            </div>
          </Link>

          <Link href="/meeting-rooms" className="bg-card p-4 sm:p-6 rounded-lg shadow hover:shadow-md transition-shadow border border-border">
            <div className="flex items-center sm:items-start flex-col sm:flex-row">
              <div className="flex-shrink-0">
              ...
              <div className="mt-2 sm:mt-0 sm:ml-4 text-center sm:text-left">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground sm:block hidden">Browse available rooms</p>
              </div>
            </div>
          </Link>

          <Link href="/history" className="bg-card p-4 sm:p-6 rounded-lg shadow hover:shadow-md transition-shadow border border-border">
            <div className="flex items-center sm:items-start flex-col sm:flex-row">
              <div className="flex-shrink-0">
              ...
              <div className="mt-2 sm:mt-0 sm:ml-4 text-center sm:text-left">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground sm:block hidden">View past bookings</p>
              </div>
            </div>
          </Link>
        </div>
        ...
        <div className="bg-card shadow rounded-lg border border-border">
          <div className="px-6 py-4 border-b border-border">
            <h2 className="text-lg font-medium text-card-foreground">Upcoming Bookings</h2>
          </div>
              ...
              <div className="space-y-4">
                {bookings.map((booking) => (
                  <Link
                    ...
                    className="group block border border-border rounded-lg p-4 hover:bg-accent hover:text-accent-foreground hover:shadow-md transition-all duration-200 cursor-pointer"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          <h3 className="text-sm font-medium text-card-foreground">{booking.roomId.name}</h3>
                        ...
                        {booking.purpose && <p className="mt-1 text-sm text-muted-foreground">{booking.purpose}</p>}
                      </div>
                      <div className="flex-shrink-0">
